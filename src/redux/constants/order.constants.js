...
export const GET_ORDERS_SHIPPER_REQUEST = "ORDER.GET_ORDERS_SHIPPER_REQUEST";
export const GET_ORDERS_SHIPPER_SUCCESS = "ORDER.GET_ORDERS_SHIPPER_SUCCESS";
export const GET_ORDERS_SHIPPER_FAILURE = "ORDER.GET_ORDERS_SHIPPER_FAILURE";